...
public class TFModel {
	...
	public <T extends RealType<T>> Dataset apply_to_dataset(Dataset currentData) {
		...
		System.out.println( "Dataset channels: " + currentData.getChannels() );
		System.out.println( "Dataset frames: " + f );
		System.out.println( "Dataset width: " + currentData.getWidth() );
		System.out.println( "Dataset height: " + currentData.getHeight() );
		
		int i = 0;
		for(long dim : dims){			
			System.out.println( "dimension" + i + ": " + dim );
			i++;
		}
